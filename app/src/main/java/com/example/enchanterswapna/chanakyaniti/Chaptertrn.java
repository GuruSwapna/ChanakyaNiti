...
public class Chaptertrn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chaptertrn);
        ...
        imleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent int2=new Intent(Chaptertrn.this,Chaptertwelve.class);
                startActivity(int2);
            }
        });
        imrght.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int1=new Intent(Chaptertrn.this,Chapterfrtn.class);
                startActivity(int1);
            }
        });
//        txt1.setMovementMethod(new ScrollingMovementMethod());
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Chaptertrn.this, MainActivity.class));
        finish();
