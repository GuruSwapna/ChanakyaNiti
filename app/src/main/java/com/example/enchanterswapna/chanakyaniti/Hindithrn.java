...
public class Hindithrn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hindithrn);
        ...
        imleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent int2=new Intent(Hindithrn.this,Hinditwelve.class);
                startActivity(int2);
            }
        });
        imrght.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int1=new Intent(Hindithrn.this,Hindifrtn.class);
                startActivity(int1);
            }
        });
//        txt1.setMovementMethod(new ScrollingMovementMethod());
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Hindithrn.this, Hindiact.class));
        finish();
    }
