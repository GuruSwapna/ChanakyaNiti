...
public class Hindisix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hindisix);
        ...
        imleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent int2=new Intent(Hindisix.this,Hindifive.class);
                startActivity(int2);
            }
        });
        imrght.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int1=new Intent(Hindisix.this,Hindiseven.class);
                startActivity(int1);
            }
        });
//        txt1.setMovementMethod(new ScrollingMovementMethod());
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Hindisix.this, Hindiact.class));
        finish();
    }
