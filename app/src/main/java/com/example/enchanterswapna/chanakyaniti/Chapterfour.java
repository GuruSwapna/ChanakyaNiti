    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent int2=new Intent(Chapterfour.this,Chapterthree.class);
                startActivity(int2);
            }
        });
        imrght.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int1=new Intent(Chapterfour.this,Chapterfive.class);
                startActivity(int1);
            }
        });
//        txt1.setMovementMethod(new ScrollingMovementMethod());
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Chapterfour.this, MainActivity.class));
        finish();
