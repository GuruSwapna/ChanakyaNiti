    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imleft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent int2=new Intent(Chaptersix.this,Chapterfive.class);
                startActivity(int2);
            }
        });
        imrght.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int1=new Intent(Chaptersix.this,Chapterseven.class);
                startActivity(int1);
            }
        });
//        txt1.setMovementMethod(new ScrollingMovementMethod());
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Chaptersix.this, MainActivity.class));
        finish();
