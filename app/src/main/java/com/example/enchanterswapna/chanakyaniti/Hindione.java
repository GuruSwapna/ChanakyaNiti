...
public class Hindione extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hindione);
        ...
        imrght.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int1=new Intent(Hindione.this,Hinditwo.class);
                startActivity(int1);
            }
        });
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(Hindione.this, Hindiact.class));
        finish();
    }
